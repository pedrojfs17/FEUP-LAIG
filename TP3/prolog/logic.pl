...
% wants to move
validateCapture(_,_,_,FinalMoveGameState,_,LenghtMove,LenghtMove,_) :-
    FinalMoveGameState='"invalid"'.

validateCapture(MoveRow,MoveColumn,GameState,FinalMoveGameState,PieceMove,Check,_,ChosenPiece) :-
...
validateCapture(MoveRow,MoveColumn,GameState,FinalMoveGameState,PieceMove,Check,LenghtMove,ChosenPiece) :-
    NewCheck is Check+1,
    validateCapture(MoveRow,MoveColumn,GameState,FinalMoveGameState,PieceMove,NewCheck,LenghtMove,ChosenPiece).
...
checkWinner(GameState,Winner):-
    ...
    (
        BlackPoints@<WhitePoints,Winner='2';
        WhitePoints@<BlackPoints,Winner='1';
        (
            write('TIED POINTS!!!!\nChecking for higher stack...\n'),
            (
              (BlackMaxLength@<WhiteMaxLength,Winner='2');
              (WhiteMaxLength@<BlackMaxLength,Winner='1');
                (Winner='0')
            )
