...
class Node extends CGFobject {
    ...
    applyTransformations() {
        ...
        for (let t of this.nodeInfo.transformations) {
            switch(t.type) {
                case "rotation":
                    mat4.rotate(transformationMatrix, transformationMatrix, t.angle, this.scene.graph.axisCoords[t.axis]);
                    break;
                case "translation":
                    mat4.translate(transformationMatrix, transformationMatrix, [t.x, t.y, t.z]);
                    break;
                case "scale":
                    mat4.scale(transformationMatrix, transformationMatrix, [t.sx, t.sy, t.sz]);
                    break;
            }
        }
